package chemicraft.inventory.inventory;
...
public class InventoryChemistWorktable implements IInventory
{
    ...
    public InventoryChemistWorktable(Container par1Container, int par2, int par3)
    {
        int k = par2 * par3;
